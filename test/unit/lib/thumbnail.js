...
describe(path.basename(__filename), () => {
  ...
  describe('do something', () => {
    ...
    it('request should return EABORT error after abort', done => {
      let thumbnail = new Thumbnail(fruitmixPath, 116, retrieveFiles) 
      thumbnail.abort()
      thumbnail.requestAsync(vpaiFingerprint, { width: 160, height: 160 })
        .then(() => {
    ...
    it('request should return EABORT error after abort', async () => {
