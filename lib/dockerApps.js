...
export function composeJsonLabel(uuid, recipe) {
  ...
  if (!validator.isUUID(uuid)) return null
...
export function uncomposeJsonLabel(json) {
  ...
  if (!validator.sig.uuid) return null
...
function checkContainerGroup(group) {
...
export function containersToApps(containers) {
  ...
  groups.forEach(group => group.broken = !checkContainerGroup(group))
