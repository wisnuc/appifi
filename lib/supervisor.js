...
async function refreshStorage() {
  ...
  memo = Object.assign(obj, { head: memo.head + 1 })
}
...
refreshStorage()
  .then(r => { 
    ...
    console.log(`storage memo head: ${memo.head}`)
  })
  .catch(e => {
    memo.head = -1
    console.log('ERROR: storage module init fails')
    console.log(e)
  })
...
module.exports = {
  ...
  head: () => { return { head: memo.head }},
  get: () => memo
}

/** simple test 
module.exports.get((e, r) => {
