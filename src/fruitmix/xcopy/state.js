...
class State {
  ...
  */
  setState (state, ...args) {
    ...
    // eg: when copy a large dir, many files conflict, 
    // and then destroy this task, the last chlid maybe in working state
    //     we destroy it while it is working, but it will setState to 'Conflict',
    //     so before setSate, check whether context is exist.
    //
    // but this is really a wierd reason. Should it commit suicide on it's own?
